...
%%
\title[ECEN 463/863]{ECEN 463/863: Digital Signal Processing}
...
\begin{frame}{Sources and Acknowledgments}
    \begin{block}{Primary Sources}
        \begin{itemize}
            \item \textbf{Textbook:} \\
            \emph{Discrete-Time Signal Processing}, Oppenheim and Schafer, 3rd Edition
            \item \textbf{UNL Digital Signal Processing Archive} \\
            (e.g., Prof. Michael Hoffman)
            \item \textbf{MIT Digital Signal Processing Course} \\
            (e.g., 6.341/6.555J, Prof. Alan V. Oppenheim)
            \item \textbf{Stanford Digital Signal Processing Course} \\
            (e.g., EE264, Prof. Julius O. Smith III)
            \item \textbf{MIT OpenCourseWare (OCW)} \\
    ...
    \vspace{0.5cm}
    \begin{block}{Note}
        Portions of these slides are adapted from the above resources for educational purposes.
    \end{block}
\end{frame}
...
\begin{columns}[t]
	...
	\begin{column}{0.25\textwidth}  %%<--- here
		\vspace{-1cm}
		\begin{center}
			\includegraphics[width=0.8\textwidth]{figs/book_cover.jpg}
		\end{center}
	\end{column}
\end{columns}
\end{block}
...
%
\begin{frame}{Administrative: Assignments}
...
\begin{frame}{Administrative: Grading}
	...
	\begin{itemize}
		\item Homework Assignments: $40\%$-$70\%$
...
\begin{itemize}
	\item The deadline to drop a full semester course and receive $100\%$ refund is September 2
        \item Last day to file a drop to remove a full semester course from student’s record is September 5
        \item The deadline to drop a full semester course and receive $75\%$ refund is September 5
        \item The deadline to drop a full semester course and receive $50\%$ refund is September 12
        \item The deadline to drop a full semester course and receive $25\%$ refund is September 19
        \item Last day to change a full semester course registration to or from “Pass/No Pass” is October 17
        \item Last day for course withdrawals noted with a grade of “W” on academic record is November 14
\end{itemize}
