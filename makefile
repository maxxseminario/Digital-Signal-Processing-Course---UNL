...
clean: 
	@powershell -Command "Get-ChildItem -Path lectures,assignments,quizzes -Include *.aux,*.log,*.out,*.toc,*.nav,*.snm,*.fls,*.fdb_latexmk,*.synctex.gz -Recurse -ErrorAction SilentlyContinue | Remove-Item -Force -ErrorAction SilentlyContinue"
